...
function LoginPageContent() {
    ...
    return (
        <div className="h-screen w-full flex items-center justify-center bg-[#091590] p-4 lg:p-10 font-sans overflow-hidden">
            <div className="w-full h-full max-w-[1600px] flex bg-white rounded-[2.5rem] overflow-hidden shadow-2xl border-2 border-white/20 relative">
                {/* Left Side - Form */}
                <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 lg:p-12 relative z-10 h-full overflow-y-auto bg-white">
                ...
                {/* Right Side - Visuals */}
                <div className="hidden lg:flex lg:w-1/2 bg-[#091590] relative overflow-hidden flex-col justify-end p-20">
                    <Image
                        src="/login.png"
                    ...
                    <div className="w-full text-center space-y-6 relative z-10">
                        <blockquote className="text-2xl md:text-3xl font-medium leading-relaxed font-serif italic text-white/90 drop-shadow-md">
                            "{mounted ? quote.text : quotes[0].text}"
                        </blockquote>
                        <div className="text-xl font-medium text-white/70 tracking-widest uppercase">
