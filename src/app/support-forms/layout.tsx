...
function SupportFormsLayoutContent({ children }: { children: React.ReactNode }) {
...
export default function SupportFormsLayout({
    children,
}: {
    ...
    return (
        <NotificationProvider>
            <SidebarProvider>
                <SupportFormsLayoutContent>{children}</SupportFormsLayoutContent>
            </SidebarProvider>
        </NotificationProvider>
    );
}
