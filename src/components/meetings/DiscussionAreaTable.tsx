...
export function DiscussionAreaTable({
    ...
    const handleAddRow = () => {
        ...
        const newRows = [...rows, createEmptyRow(nextSno)];
                        ...
                        <tbody className="divide-y divide-gray-200 text-xs">
                            {rows.map((row, index) => (
                                <tr key={row.id} className="hover:bg-blue-50/20 transition-colors group">
                                    ...
                                    <td className="py-2 px-2 align-top relative">
                                        {readOnly ? (
                                            ...
                                            <div className="relative space-y-1.5">
                                                ...
                                                {/* User Mention Suggestions Popup (Fixed Position to avoid overflow clipping) */}
                                    ...
                                    <td className="py-2 px-2 align-top relative">
                                        {readOnly ? (
                                            ...
                                            <div className="relative">
                                                ...
                                                {/* Project Mention Suggestions Popup (Fixed Position to avoid overflow clipping) */}
                                    ...
                                    <td className="py-2 px-2 align-top">
                                        {readOnly ? (
                                            <span
                                                ...
                                                className={cn(
                                                    "inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-extrabold uppercase border shadow-2xs",
                                    ...
                                    <td className="py-2 px-2 align-top">
                                        {readOnly ? (
                                            <p title={row.remarks} className="text-xs text-gray-600 py-1 px-1">
                                                {row.remarks || '-'}
                                            </p>
                                        ) : (
                                            <input
