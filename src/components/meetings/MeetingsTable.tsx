                                ...
                                >
                                    ...
                                    <td className="px-2 py-1">
                                        <div className="flex items-center gap-2">
                                            <div className="w-5 h-5 bg-[#091590]/10 rounded-md flex items-center justify-center flex-shrink-0 group-hover:bg-[#091590]/20 transition-colors">
                                                <FileSpreadsheet className="w-3 h-3 text-[#091590]" />
                                            </div>
                                            <div>
                                                <p className="text-xs font-bold text-gray-900 group-hover:text-[#091590] transition-colors">
